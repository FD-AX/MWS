# DocReview AI — предварительная проверка ТЗ на потоки и витрины данных

DocReview AI разработан для кейса МТС NET на хакатоне ИТМО. Сервис проверяет ТЗ
до передачи в разработку: находит пропуски, неоднозначности и противоречия,
привязывает каждое замечание к исходному тексту и формулирует вопрос аналитику.
Решение о готовности документа всегда остаётся за человеком.
