...
def normalize(s: str) -> str:
    """Нормализация для поиска цитат: пробелы (в т.ч. NBSP), ё, кавычки, все виды дефисов и тире, регистр.
    EXP-24: модели отдают неразрывный дефис U+2011 («RAW‑слой», «2‑е число») — цитата дословная,
    а substring-проверка её не находила."""
